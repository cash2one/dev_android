...
public class HDScreen {
	...
	private static HDScreen mInstance = null;
	public static HDScreen getInstance() {
		if (null == mInstance) {
			mInstance = new HDScreen(); 
		}
		return mInstance;
	}
	...
	public static void initParam() {
		if ((0 == mDensity) || (0 == mDensityDpi)) {
			android.util.DisplayMetrics display = AppInst.instance.getResources().getDisplayMetrics();
			if (null != display) {
...
//        view.measure(width,height);
   ...
   public static String getDenstyMode(int mode) {
	   DisplayMetrics display = AppInst.instance.getResources().getDisplayMetrics();
